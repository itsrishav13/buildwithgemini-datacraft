...
root_agent = Agent(
    ...
    instruction=(
        ...
        "add new table definitions to the catalog, and optimize SQL queries across PostgreSQL, BigQuery, and Snowflake. "
        ...
        "and use fetch_data_tool_metadata to fetch live stats and metadata for open-source data engineering tools."
    ),
    tools=[
        list_tables,
        get_table_details,
