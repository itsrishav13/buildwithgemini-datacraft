...
MEMORY_BANK_ID = "6232764180978466816"
...
def get_memory_service():
    ...
    engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", MEMORY_BANK_ID)
    from google.adk.memory.vertex_ai_memory_bank_service import VertexAiMemoryBankService

    return VertexAiMemoryBankService(
        project=os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-02-502ecf129e21"),
